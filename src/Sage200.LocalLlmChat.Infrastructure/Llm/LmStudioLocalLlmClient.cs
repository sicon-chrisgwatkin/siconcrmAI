...
public sealed class LmStudioLocalLlmClient : ILocalLlmClient
{
    private readonly HttpClient _httpClient;
    private readonly LocalLlmConnectorOptions _options;

    public LmStudioLocalLlmClient(HttpClient httpClient, LocalLlmConnectorOptions options)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint = new Uri(_options.Endpoint, "/v1/chat/completions");
        ...
        {
            throw new InvalidOperationException("LM Studio did not return choices[0].message.content.");
        }
